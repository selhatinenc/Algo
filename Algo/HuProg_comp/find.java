...
class find {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(fs.computeArea(1, 2, 3, 4, 3, 3, 3, 2) );
...
class Solution {
    ...
    public  int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) {
        ...
        if(X1arr[1]<=X2arr[1]){
            if(X1arr[1]<tempx1)tempx2=tempx1;
            else
            tempx2=X1arr[1];
        }
        else{
            if(X2arr[1]<tempx1)tempx2=tempx1;
            else
            tempx2=X2arr[1];
        }
        ...
        if(Y1arr[1]<=Y2arr[1]){
            if(Y1arr[1]<heig1)heigh2=heig1;
            else
            heigh2=Y1arr[1];
        }
        else{
            if(Y2arr[1]<heig1)heigh2=heig1;
            else
            heigh2=Y2arr[1];
        }

        return ((X1arr[1]-X1arr[0])*(Y1arr[1]-Y1arr[0]))+((X2arr[1]-X2arr[0])*(Y2arr[1]-Y2arr[0]))-((tempx2-tempx1)*(heigh2-heig1));
    }
